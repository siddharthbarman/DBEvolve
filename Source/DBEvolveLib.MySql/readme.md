...
```
dotnet add package SByteStream.DBEvolve.MySql
```
...
```
var evolver = new MySqlDBEvolver(); // Upgrade only up to version 101 
...
evolver.Evolve(logger: logger, 
    connectionString: "server=localhost; port=3306; uid=root; pwd=password123; database=MyAppDb", 
